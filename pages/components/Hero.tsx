...
const Hero = () => {
    return (
        <div className="h-screen flex flex-col md:flex-row w-full justify-center">
            ...
            <div className="my-16 md:my-auto ml-0 md:ml-16 xl:ml-32">
                ...
                <div className="mt-10 flex gap-5 justify-center md:justify-start">
                    <div className="bg-white h-12 w-12 2xl:h-14 2xl:w-14 text-center rounded-full flex group hover:bg-lightblue hover:cursor-pointer transition-all duration-300 easy-in-out"><a href="#" rel="noreferrer" target="_blank" className="my-auto mx-auto text-xl 2xl:text-2xl text-darkblue group-hover:text-white group-hover:scale-[1.1] transition-all duration-300 ease-in-out"><FaLinkedinIn /></a></div>
